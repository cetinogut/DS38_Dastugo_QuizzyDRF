...
export const QuizSelect = () => {
  ...
  const API_URL = "http://127.0.0.1:8000/quizzy/";
  const FRONTEND_URL = "http://127.0.0.1:3000/r/"
    ...
    <React.Fragment>
      ...
      <Container maxWidth="sm" component="main" className={classes.heroContent}>
        ...
        >
          ...
          selection of quizzes. Choose from 500+ quizzes with new additions
